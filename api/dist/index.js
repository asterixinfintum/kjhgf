...
var _messager = _interopRequireDefault(require("./routes/messager"));
...
app.get('/trending-presale', function (req, res) {
  res.sendFile(_path["default"].join(__dirname, '..', 'public', 'trendingpresales.html'));
});
app.get('/favicon', function (req, res) {
  res.sendFile(_path["default"].join(__dirname, '..', '/public/imgs/cropped-CoinGape_logo2-32x32.webp'));
});
app.use(_express["default"]["static"]('public'));
app.use(_messager["default"]);
